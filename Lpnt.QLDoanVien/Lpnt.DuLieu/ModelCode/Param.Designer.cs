...
namespace Lpnt.DuLieu
{
    ...
    public partial class Param : BaseObject
    {
        ...
        Lpnt.DuLieu.DataType fValueType;
        [DevExpress.Xpo.DisplayName(@"Kiểu dữ liệu")]
        public Lpnt.DuLieu.DataType ValueType
        {
            get { return fValueType; }
            set { SetPropertyValue<Lpnt.DuLieu.DataType>("ValueType", ref fValueType, value); }
        }
        string fValue;
        ...
        Lpnt.DuLieu.ParamCategory fParamCategory;
        public Lpnt.DuLieu.ParamCategory ParamCategory
        {
            get { return fParamCategory; }
            set { SetPropertyValue<Lpnt.DuLieu.ParamCategory>("ParamCategory", ref fParamCategory, value); }
        }
    }
