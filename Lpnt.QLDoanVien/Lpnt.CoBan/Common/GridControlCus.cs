...
{
    [ToolboxItem(true)]
    public class GridControlCus : GridControl
    {
        public GridControlCus()
        {
            Load += GridControlCus_Load;
        }
        private void GridControlCus_Load(object sender, EventArgs e)
        {
            var view = MainView as GridViewCus;
            if (view == null) return;
        ...
        {
            return CreateView("GridViewCus");
        }
        protected override void RegisterAvailableViewsCore(InfoCollection collection)
        {
            base.RegisterAvailableViewsCore(collection);
            collection.Add(new KGridViewInfoRegistrator());
        }
    }
    public class GridViewCus : GridView
    {
        public GridViewCus() : this(null)
        {
        }
        public GridViewCus(GridControl grid)
            : base(grid)
        {
            BeginInit();
            ...
            CustomDrawRowIndicator += GridViewCus_CustomDrawRowIndicator;
            FocusedRowChanged += KGridView_FocusedRowChanged;
            EndInit();
        }
        /// <summary>
        ...
        {
            get { return "GridViewCus"; }
        }
        private void KGridView_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
        ...
        private void GridViewCus_CustomDrawRowIndicator(object sender, RowIndicatorCustomDrawEventArgs e)
        {
            if (e.Info.IsRowIndicator && e.RowHandle >= 0)
                e.Info.DisplayText = (e.RowHandle + 1).ToString();
        }
        private void GridViewCus_CustomDrawCell(object sender, RowCellCustomDrawEventArgs e)
        {
    ...
    public class KGridViewInfoRegistrator : GridInfoRegistrator
    {
