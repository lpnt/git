    ...
    public static class ConnectionHelper
    {
        ...
        public static bool Connect()
        {
            ...
            if (serverTyppe == (int)ServerType.ACCESS)
            {
                if (!db.Contains(@"\"))
                {
                    db = Application.StartupPath + @"\Data\" + db;
        ...
        public static void BackupAccess()
        {
            ...
            saveDlg.FileName = string.Format("{0}{1:ddMMyyyy_HHmmss}.mdb", Constants.TEN_CO_SO_DU_LIEU, DateTime.Now);
            saveDlg.Filter = "Access File (*.mdb)|*.mdb|All files (*.*)|*.*";
        ...
        {
            var opdl = new OpenFileDialog();
            opdl.Filter = "Access File (*.mdb)|*.mdb|All files (*.*)|*.*";
        ...
        public static void BackupSQL()
        {
            ...
            SaveFileDialog saveDlg = new SaveFileDialog() { FileName = string.Format("{0}{1:ddMMyyyy_HHmmss}.bak", Constants.TEN_CO_SO_DU_LIEU, DateTime.Now), Filter = "Backup (*.bak)|*.bak" };
